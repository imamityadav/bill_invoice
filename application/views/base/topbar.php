          ...
          <ul class="nav navbar-nav navbar-right">
                ...
                <div class="dropdown-body">
                  <div class="list-group list-group-divided custom-scrollbar">
                    <a class="list-group-item" href="#">
                      <div class="notification">
                        <div class="notification-media">
                          <img class="circle" width="40" height="40" src="<?php echo base_url();?>assets/img/0299419341.jpg" alt="Harry Jones">
                        </div>
                    ...
                    <a class="list-group-item" href="#">
                      <div class="notification">
                        <div class="notification-media">
                          <img class="circle" width="40" height="40" src="<?php echo base_url();?>assets/img/0310728269.jpg" alt="Daniel Taylor">
                        </div>
                        <div class="notification-content">
                    ...
                    <a class="list-group-item" href="#">
                      <div class="notification">
                        <div class="notification-media">
                          <img class="circle" width="40" height="40" src="<?php echo base_url();?>assets/img/0460697039.jpg" alt="Charlotte Harrison">
                        </div>
                        <div class="notification-content">
                    ...
                    <a class="list-group-item" href="#">
                      <div class="notification">
                        <div class="notification-media">
                          <img class="circle" width="40" height="40" src="<?php echo base_url();?>assets/img/0531871454.jpg" alt="Ethan Walker">
                        </div>
                        <div class="notification-content">
                    ...
                    <a class="list-group-item" href="#">
                      <div class="notification">
                        <div class="notification-media">
                          <img class="circle" width="40" height="40" src="<?php echo base_url();?>assets/img/0601274412.jpg" alt="Sophia Evans">
                        </div>
                        <div class="notification-content">
                    ...
                    <a class="list-group-item" href="#">
                      <div class="notification">
                        <div class="notification-media">
                          <img class="circle" width="40" height="40" src="<?php echo base_url();?>assets/img/0777931269.jpg" alt="Harry Walker">
                        </div>
                        <div class="notification-content">
                    ...
                    <a class="list-group-item" href="#">
                      <div class="notification">
                        <div class="notification-media">
                          <img class="circle" width="40" height="40" src="<?php echo base_url();?>assets/img/0872116906.jpg" alt="Emma Lewis">
                        </div>
                        <div class="notification-content">
                    ...
                    <a class="list-group-item" href="#">
                      <div class="notification">
                        <div class="notification-media">
                          <img class="circle" width="40" height="40" src="<?php echo base_url();?>assets/img/0980726243.jpg" alt="Eliot Morgan">
                        </div>
                        <div class="notification-content">
                          <small class="notification-timestamp">Sep 15</small>
                ...
                <div class="dropdown-body">
                  <div class="list-group list-group-divided custom-scrollbar">
                    ...
                    <a class="list-group-item" href="#">
                      <div class="notification">
                        <div class="notification-media">
                          <img class="circle" width="40" height="40" src="<?php echo base_url();?>assets/img/0180441436.jpg" alt="Teddy Wilson">
                        </div>
                        <div class="notification-content">
            ...
            <li class="dropdown hidden-xs">
              <button class="navbar-account-btn" data-toggle="dropdown" aria-haspopup="true">
                <img class="circle" width="36" height="36" src="<?php echo base_url();?>assets/img/0180441436.jpg" alt="Teddy Wilson"> Teddy Wilson
